...
<body class="bg-gray-900 flex flex-wrap justify-center min-h-screen">
    ...
    <?php foreach ($animais as $animal): ?>
        <div class="bg-white shadow-lg rounded-lg w-80 p-4 m-4 max-h-[600px]">
            ...
            <p class="text-gray-600">Data: <?= date('d/m/Y', strtotime($a["dia"])) ?></p>
            ...
            <form action="excluirCard.php" method="get" onsubmit="return confirm('Tem certeza que deseja desmarcar o serviço deste pet?');">
